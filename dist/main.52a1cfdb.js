...
var saveList = function saveList(objList) {
  var string = JSON.stringify(objList);
  localStorage.setItem('x', string);
  render();
};

var $siteList = $('.siteList');
var $lastLi = $siteList.find('li.last'); //【F】根据 hashMap 渲染站点列表

var render = function render() {
  $siteList.find('li:not(.last)').remove();
  hashMap.forEach(function (item, index) {
    var $li = $("\n      <li>\n        <a href=\"".concat(item.url, "\">\n          <div class=\"site\">\n            <div class=\"logo\">").concat(item.logo.toUpperCase(), "</div>\n            <div class=\"link\">").concat(simplifyUrl(item.url), "</div>\n            <div class=\"close\">\n              <svg class=\"icon\">\n                <use xlink:href=\"#icon-close\"></use>\n              </svg>\n            </div>\n          </div>\n        </a>\n      </li>\n    ")).insertBefore($lastLi); // 监听 关闭按钮 的点击
